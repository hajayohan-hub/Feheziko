...
const categories = [
  ...
  [
    ...
    ["Frère", "n.m.", "Rahalahy / Anadahy", "Membre masculin de la même fratrie.", "J'ai un frère plus âgé.", "Manana rahalahy zokiny kokoa aho."],
    ["Sœur", "n.f.", "Rahavavy / Anabavy", "Membre féminin de la même fratrie.", "Ma sœur étudie à l'université.", "Mpianatra any amin'ny oniversite ny anabaviko."],
    ...
    ["Génération", "n.f.", "Taranaka", "Ensemble des personnes nées à la même époque.", "Chaque génération a ses valeurs.", "Manana ny sora-tsainy ny taranaka tsirairay."],
    ["Ancêtre", "n.m.", "Razana", "Personne dont on descend.", "Le respect des ancêtres est important.", "Zava-dehibe ny fanajàna ny razana."],
    ...
    ["Beau-père", "n.m.", "Razana lahy / Belle-famille", "Père du conjoint ou second mari de la mère.", "Mon beau-père est très gentil.", "Tena tsara fanahy ny beau-père-ko."],
    ["Belle-mère", "n.f.", "Razana vavy / Belle-famille", "Mère du conjoint ou seconde femme du père.", "Ma belle-mère habite à Majunga.", "Monina any Mahajanga ny belle-mère-ko."],
    ["Fiancé", "n.m.", "Olom-fianahana lahy", "Homme engagé par des promesses de mariage.", "Son fiancé travaille en ville.", "Miasa ao an-tànana ny fiancé-ny."],
    ["Fiancée", "n.f.", "Olom-fianahana vavy", "Femme engagée par des promesses de mariage.", "Sa fiancée habite tout près.", "Monina akaiky kely eo ny fiancée-ny."],
    ["Jumeaux", "n.m.pl.", "Kambana", "Deux enfants nés d'une même grossesse.", "Les jumeaux se ressemblent beaucoup.", "Mifampitovy be ireo kambana ireo."],
    ["Adolescent", "n.m.", "Tanora hianatra / Tanora", "Jeune personne entre l'enfance et l'âge adulte.", "Les adolescents aiment le sport.", "Tia spora ny tanora."]
  ]
];

categories.forEach(cat => {
  cat.forEach(row => add(...row));
});

console.log("Loaded manual categories. Total count:", items.length);
